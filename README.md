...
MoneySiren `v0.1.0-alpha.14` is published for local alpha review.
...
```bash
msiren install --all --tag v0.1.0-alpha.14 --dir ./moneysiren-release
```
...
npm run release:check -- v0.1.0-alpha.14
```
...
```bash
npm run release:check -- v0.1.0-alpha.14 --allow-unsigned-prerelease-windows
```
