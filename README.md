...
MoneySiren `v0.1.6` is the current public local patch release over the initial `v0.1.0` public local release.
...
```bash
msiren install --web --tag v0.1.6 --dir ./moneysiren-release
```
