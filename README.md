...
MoneySiren is preparing `v0.1.0-alpha.3` for local review.
...
```bash
msiren install --all --tag v0.1.0-alpha.3 --dir ./moneysiren-release
```
...
npm run release:check -- v0.1.0-alpha.3
```
