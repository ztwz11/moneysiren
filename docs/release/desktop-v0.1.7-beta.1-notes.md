# MoneySiren v0.1.7-beta.1

MoneySiren v0.1.7-beta.1 is an explicitly unsigned Windows preview for early HUD testing while trusted code signing is unavailable.
