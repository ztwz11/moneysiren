# MoneySiren v0.1.7-beta.4

MoneySiren v0.1.7-beta.4 is an explicitly unsigned Windows preview. It refreshes the product identity and prepares the same icon system for a later macOS release without publishing macOS artifacts in this Windows-only run.
...
msiren install --all --allow-unsigned-hud --tag v0.1.7-beta.4
msiren hud
```
